...
services:
  hytale:
    ...
    volumes:
      - hytale-data:/server              # Persist server files and world data
      - hytale-home:/home/hytale         # Persist OAuth tokens and config
...
User home directory:
- OAuth tokens (`~/.config/hytale/tokens/`)
- Session tokens and profile cache
